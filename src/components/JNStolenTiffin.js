...
// import './JNStolenTiffin.css'

import JNStolenBan from '../image/JNStolenBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNStolenTiffin() {
    return (
        <>
            <div className='jnstolen-parent-container'>
                <img src={JNStolenBan} className='jnstolen-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnstolen-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>stolen tiffin</h1>
                    </Col>
