...
// import './JNCuisine.css'

import JNCuisineBan from '../image/JNCuisineBan.png';
...
function JNCuisine() {
    return (
        <>
            <div className='jncuisine-parent-container'>
                <img src={JNCuisineBan} className='jncuisine-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jncuisine-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Cuisine</h1>
                    </Col>
