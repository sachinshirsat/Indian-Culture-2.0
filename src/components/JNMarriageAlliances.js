...
// import './JNMarriageAlliances.css'

import JNMarriBan from '../image/JNMarriBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNMarriageAlliances() {
    return (
        <>
            <div className='jnmaralli-parent-container'>
                <img src={JNMarriBan} className='jnmaralli-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnmaralli-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Marriage Alliances</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnmaralli-img">
                            <img
                                src={JNMonuImg1}
...
export default JNMarriageAlliances
