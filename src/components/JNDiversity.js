...
// import './JNDiversity.css'

import JNDiversityBan from '../image/JNDiversityBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNDiversity() {
    return (
        <>
            <div className='jndiversity-parent-container'>
                <img src={JNDiversityBan} className='jndiversity-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jndiversity-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Diversity</h1>
                    </Col>
