...
function Maincourse() {
    ...
    const fcmaincourseresultpage = () => {
        window.open('/fcmaincourseresultpage', '_parent');
    };
                ...
                <main className="fnc-main-course-lst-page-content">
                    ...
                    <div className="fnc-main-course-lst-listcard">
                        <div className="fnc-main-course-lst-content">
                            ...
                            <button className="fnc-main-course-lst-listbtn" onClick={fcmaincourseresultpage}>View</button>
                        </div>
                    </div>
                    <div className="fnc-main-course-lst-listcard">
                        <div className="fnc-main-course-lst-content">
