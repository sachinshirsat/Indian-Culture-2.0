...
function PhotoArchiveListResultpage() {
    ...
    const [details, setDetails] = useState({
        ...
        field_dc_subject: "Loading...",
        field_dc_description: "Loading...",
        field_dc_identifier_other: "Loading...",
    ...
    useEffect(() => {
        if (itemData?.title) {
            ...
            Api.getPhotoArchiveByTitle(itemData.title)
                .then((data) => {
    ...
    return (
        <>
            {/* <Container>
                ...
                <div className='parent-container' onClick={() => openPopup(imageSrc)}>
...
export default PhotoArchiveListResultpage;
