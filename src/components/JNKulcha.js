...
import JNKulchaBan from '../image/JNKulchaBan.png';
...
function JNKulcha() {
    return (
        <>
            <div className='jnkulcha-parent-container'>
                <img src={JNKulchaBan} className='jnkulcha-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnkulcha-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>kulcha on the flag</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnkulcha-img">
                            <img
                                src={JNMonuImg1}
