...
// import './JNDesignVocabulary.css'

import JNDesginBan from '../image/JNDesginBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNDesignVocabulary() {
    return (
        <>
            <div className='jndesign-parent-container'>
                <img src={JNDesginBan} className='jndesign-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jndesign-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
...
export default JNDesignVocabulary
