...
function SelectPaintingsOfRashtrapatiBhavanResultpage() {
  ...
  const fetchDefaultPainting = async () => {
    ...
    try {
      ...
      const data = await Api.getSelectPaintingsOfRashtrapatiBhavan();
  ...
  const fetchSnippetDetails = async (title) => {
    ...
    setError(null);
    try {
      const data = await Api.getSelectPaintingsOfRashtrapatiBhavanByTitle(title);
...
export default SelectPaintingsOfRashtrapatiBhavanResultpage;