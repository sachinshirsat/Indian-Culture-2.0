...
import Arcicon from "../../image/imagesOrange_3 1.webp";
...
import MuseumPaintings from "./MuseumPaintings";

function MuseumPaintingsResultpage() {
    ...
    const [details, setDetails] = useState({
        ...
        field_dc_date_issued: "Loading...",
        field_dc_publisher: "Loading...",
        field_dc_source: "Loading...",
    ...
    useEffect(() => {
        if (itemData?.title) {
            console.log("Fetching details for:", itemData);
            Api.getMuseumPaintingsByTitle(itemData.title)
                .then((data) => {
                    ...
                    if (data && data.rows?.search_results?.length > 0) {
                        ...
                        if (record) {
                            ...
                            setDetails({
                                ...
                                field_dc_date_issued: record.field_dc_date_issued || "-NA-",    
                                field_dc_publisher: record.field_dc_publisher || "-NA-",
                ...
                <Row>
                    <Col>
                        <p className="arcpara">
                            ...
                            <strong>Issue Date:</strong> {details.field_dc_date_issued} <br />
                           <strong>Publisher:</strong> {details.field_dc_publisher} <br />
                           ...
                           {/*  <strong>Format Source:</strong> {details.field_dc_format_source} <br />
                           
                            <strong>Coverage Spatial:</strong> {details.field_dc_coverage_spatial} <br />
                            <strong>Coverage Temporal:</strong> {details.field_dc_coverage_temporal} <br />
                            ...
                            <Table striped>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{details.field_dc_date_issued}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{details.field_dc_format_source}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>dc.publisher</td>
                                        <td>{details.field_dc_publisher}</td>
                                    </tr>
                                    <tr>
                                        <td>dc.type</td>
                                    ...
                                    <tr>
                                        <td>dc.identifier.accessionnum</td>
                                        <td>{details.field_dc_identifier_accessionnum}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{details.field_dc_coverage_temporal}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>dc.format.extent</td>
                                        <td>{details.field_dc_format_extent}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>dc.format.subject</td>
                                        <td>{details.field_dc_format_subject}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>dc.format.material</td>
                                        <td>{details.field_dc_format_material}</td>
                                    </tr> */}
                                </tbody>
                            </Table>
                        </Accordion.Body>
...
export default MuseumPaintingsResultpage;
