...
// import './JNSourcesofWealth.css'

import JNSourcesBan from '../image/JNSourcesBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNSourcesofWealth() {
    return (
        <>
            <div className='jnsource-parent-container'>
                <img src={JNSourcesBan} className='jnsource-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnsource-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Sources of Wealth</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnsource-img">
                            <img
                                src={JNMonuImg1}
...
export default JNSourcesofWealth
