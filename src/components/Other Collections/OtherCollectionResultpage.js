...
import PdfViewer from "./OtherCollPdfViewer";
import PdfFlipbook from "./OtherCollPdfFlipbook";
import Arcicon from "../../image/other 1.webp";
...
function OtherCollectionResultpage() {
    ...
    useEffect(() => {
    if (itemData?.title) {
        Api.getOthercollectionsByTitle(itemData.title)
            .then((data) => {
                if (data && data.rows?.search_results?.length > 0) {
                    ...
                    if (record) {
                        ...
                        setDetails({
                            ...
                            dateCopyright: record.field_dc_date_copyright || "-NA-",
                            accessionNumber: record.field_dc_identifier_accessionnum || "-NA-",
                            ...
                            <Table striped>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{details.dateCopyright}</td>
                                    </tr>

                                    <tr>
                                        <td>dc.identifier.accessionnum</td>
                                        <td>{details.accessionNumber}</td>
                                    </tr>
...
export default OtherCollectionResultpage;