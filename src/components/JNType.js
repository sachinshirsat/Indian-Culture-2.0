...
import JNTypeBan from '../image/JNTypeBan.png';
...
function JNType() {
    return (
        <>
            <div className='jntype-parent-container'>
                <img src={JNTypeBan} className='jntype-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jntype-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Types</h1>
                    </Col>
