...
import JNEsraBan from '../image/JNEsraBan.png';
...
function JNEsra() {
    return (
        <>
            <div className='jnersa-parent-container'>
                <img src={JNEsraBan} className='jnersa-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnersa-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Princess esra</h1>
                    </Col>
