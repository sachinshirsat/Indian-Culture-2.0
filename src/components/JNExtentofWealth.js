...
// import './JNExtentofWealth.css'

import JNExtWealthBan from '../image/JNExtWealthBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNExtentofWealth() {
    return (
        <>
            <div className='jnext-parent-container'>
                <img src={JNExtWealthBan} className='jnext-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnext-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Extent of Wealth</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnext-img">
                            <img
                                src={JNMonuImg1}
...
export default JNExtentofWealth
