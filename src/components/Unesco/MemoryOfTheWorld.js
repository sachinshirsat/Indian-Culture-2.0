...
const SkeletonCard = () => {
  ...
  const fetchPageData = async (page) => {
    try {
      ...
      const data = await Api.getMemoryOfTheWorld(query);
  ...
  const handleViewClick = (snippet) => {
    ...
    navigate("/unesco-memory-of-the-world-details", {
      state: {
        item: {
          title: snippet.title,
          type: snippet.type,
    ...
    <>
      ...
      <Container fluid>
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Memory of the World</Breadcrumb.Item>
        </Breadcrumb>
      </Container>
...
export default MemoryOfTheWorld;