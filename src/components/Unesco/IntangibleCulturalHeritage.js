...
const SkeletonCard = () => {
  return (
    ...
    function IntangibleCulturalHeritage() {
  ...
  const fetchPageData = async (page) => {
    try {
      ...
      const data = await Api.getUnescoIntangibleCulturalHeritage(query);
  ...
  const fetchSearchResults = async (text, page) => {
    try {
      setIsSearching(true);
      const data = await Api.searchUnescoIntangibleCulturalHeritage(text, page);
  ...
  const handleViewClick = (snippet) => {
    ...
    navigate("/unesco-intangible-cultural-heritage-details", {
      state: {
        item: {
          title: snippet.title,
          type: snippet.type,
    ...
    <>
      ...
      <Container fluid>
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Intangible Cultural Heritage</Breadcrumb.Item>
        </Breadcrumb>
      </Container>
