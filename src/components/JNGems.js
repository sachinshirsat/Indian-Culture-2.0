...
function JNGems() {
    return (
        <>
            <div className='jngems-parent-container'>
                <img src={JNTypeBan} className='jngems-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jngems-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>gems & Stones</h1>
                    </Col>
