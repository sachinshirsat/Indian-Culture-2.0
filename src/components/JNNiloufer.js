...
// import './JNNiloufer.css'

import JNNilBan from '../image/JNNilBan.png';
...
function JNNiloufer() {
    return (
        <>
            <div className='jnnilo-parent-container'>
                <img src={JNNilBan} className='jnnilo-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnnilo-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Princess Niloufer</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnnilo-img">
                            <img
                                src={JNMonuImg1}
