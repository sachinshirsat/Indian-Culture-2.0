...
import PdfViewer from "./EbooksPdfViewer";
import PdfFlipbook from "./EbooksPdfFlipbook";
...
function EbooksResultpage() {
    ...
    useEffect(() => {
    if (itemData?.title) {
        Api.getEbooksByTitle(itemData.title)
            .then((data) => {
...
export default EbooksResultpage;