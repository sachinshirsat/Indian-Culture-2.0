...
// import './JNEcoCrisis.css'

import JNExtWealthBan from '../image/JNExtWealthBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNEcoCrisis() {
    return (
        <>
            <div className='jnecocrisis-parent-container'>
                <img src={JNExtWealthBan} className='jnecocrisis-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnecocrisis-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
