...
function NEABuildHeritage() {
    ...
    const neabuiltherresultpage = () => {
        window.open('/neabuiltherresultpage', '_parent');
    };
    return (
        <>
                ...
                <Container style={{ marginTop: '20px' }}>
                    ...
                    <Offcanvas show={show} onHide={handleClose} backdrop="static" className='sidepanel'>
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title style={{ textAlign: 'center' }}>Built Heritage Filter</Offcanvas.Title>
                        </Offcanvas.Header>
                ...
                <main className="neasnap-page-content">
                    <div className="neasnap-listcard">
                        <div className="neasnap-content">
                            ...
                            <h2 className="neasnap-title ">Soulful Shivsagar</h2>

                            {/* <p className="copy">Check out all of these gorgeous mountain trips with beautiful views of, you guessed it, the mountains</p> */}
                            <button className="neasnap-listbtn" onClick={neabuiltherresultpage}>View</button>
                        </div>
                    </div>
                    <div className="neasnap-listcard">
                        <div className="neasnap-content">
...
export default NEABuildHeritage
