...
// import './JNNizamNecklace.css'

import JNNiznecBan from '../image/JNNiznecBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNNizamNecklace() {
    return (
        <>
            <div className='jnnizamneck-parent-container'>
                <img src={JNNiznecBan} className='jnnizamneck-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnnizamneck-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>NIZAM OF HYDERABAD NECKLACE</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnnizamneck-img">
                            <img
                                src={JNMonuImg1}
...
export default JNNizamNecklace
