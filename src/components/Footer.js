              ...
              <div className="col-xl-4 col-lg-4 mb-50">
                <div className="footer-widget">
                  ...
                  <div className="footer-text">
                    <p>The Indian Culture Portal is a part of the National Virtual Library of India project,
                      funded by the Ministry of Culture, Government of India. The portal has been created and
                      developed by the Indian Institute of Technology, Bombay. Data has been provided by organisations
                      of the Ministry of Culture and curated by Indira Gandhi National Open University.</p>
                  </div>
