...
// import './JNSalarJungs.css'

import JNSalarBan from '../image/JNSalarBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNSalarJungs() {
    return (
        <>
            <div className='jnsalar-parent-container'>
                <img src={JNSalarBan} className='jnsalar-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnsalar-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Salar Jungs</h1>
                    </Col>
