...
// import './JNTerritories.css'

import JNTerritoriesBan from '../image/JNTerritoriesBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';


function JNTerritories() {
    return (
        <>
            <div className='jnterri-parent-container'>
                <img src={JNTerritoriesBan} className='jnterri-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnterri-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>TERRITORIES OF THE NIZAM</h1>
                    </Col>
                </Row>

                <Row className="justify-content-center align-items-center">
                    <Col xs={12} md={6} lg={4} className="d-flex justify-content-center mb-4 mb-lg-0">
                        <div className="jnterri-img">
                            <img
                                src={JNMonuImg1}
