...
import PdfViewer from "./GazePdfViewer";
import PdfFlipbook from "./GazePdfFlipbook";
...
function GazettesGazetteersResultpage() {
    ...
    useEffect(() => {
    if (itemData?.title) {
        Api.getGazettesGazetteersByTitle(itemData.title)
            .then((data) => {
                if (data && data.rows?.search_results?.length > 0) {
                    ...
                    if (record) {
                        ...
                        setDetails({
                            ...
                            volumeNumber: record.field_dc_identifer_volumenumber || "-NA-",
                            classNumber: record.field_dc_identifier_classnumber || "-NA-",
                            medium: record.field_dc_format_medium || "-NA-",
                            location: record.field_cdwa_location || "-NA-",
                            ...
                            <Table striped>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{details.volumeNumber}</td>
                                    </tr>
                                    <tr>
                                        <td>dc.classnumber</td>
                                        <td>{details.classNumber}</td>
                                    </tr>
...
export default GazettesGazetteersResultpage;