...
// import './JNMonuments.css'

import JNMonumentsBan from '../image/JNMonuBan.png';
import JNMonuImg1 from '../image/Ellipse 12.png';

function JNMonuments() {

  

    return (
        <>
            <div className='jnmonu-parent-container'>
                <img src={JNMonumentsBan} className='jnmonu-banner' alt='Free Banner' />
            </div>
            {/* left start */}
            <Container className="jnmonu-header" fluid style={{ maxWidth: '1440px', margin: '0 auto' }}>
                <Row>
                    <Col>
                        <h1>Charminar</h1>
                    </Col>
                ...
                <Row className="justify-content-center align-items-center">
                    ...
                    <Col xs={12} md={12} lg={8} className="order-lg-1">
                        <p>
                            ...
                            The King Kothi Palace was constructed by Kamal Khan (later sold to the Nizam of Hyderabad who at that time was a mere 13 years old). The Nizam moved into the new palace away from his father who lived in the Chowmahalla Palace.</p>
                        <p>What was peculiar about the palace was that the main gates, the corridors, doors and windows of the palace were engraved with the initials ‘KK’, signifying its owner, Kamal Khan.</p>
                        <p> After it became the royal residence of the young Nizam, a farman was passed that denoted that “KK” would now stand for King Kothi instead of Kamal Khan.</p>
                        <p>The palace had three main buildings. One was a massive library used by the Nizam and the other two faced the Eden Gardens and were used primarily for official and ceremonial purposes.</p>
                        <p>The buildings were built in the European style of architecture, with canopies over the windows, the sloping tiled roofs, the intricate woodwork and the classic semicircular arches.</p>
                        <p> As of today, only two buildings within the palace survive. The main building that now houses a hospital and the Mubarak Mansion or the Nazri Bagh that accommodates the offices of the Nizam’s private estates. To the east of the Mubarak Mansion is the Ghadial Gate and the Judi Mosque.
